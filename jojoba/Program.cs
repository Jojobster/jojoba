...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("Time after adding 5 minutes: " + currentTime.Hours + ":" + currentTime.Minutes + ":" + currentTime.Seconds);
        currentTime.SaveToJsonFile("jojoba.json");
        Console.WriteLine("Time from Json:" + Time.LoadFromJsonFile("jojoba.json").Hours + ":" + Time.LoadFromJsonFile("jojoba.json").Minutes + ":" + Time.LoadFromJsonFile("jojoba.json").Seconds);
    }
}